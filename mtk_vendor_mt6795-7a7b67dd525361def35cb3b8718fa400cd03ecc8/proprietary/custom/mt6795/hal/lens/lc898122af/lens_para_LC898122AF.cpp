...
const NVRAM_LENS_PARA_STRUCT LC898122AF_LENS_PARA_DEFAULT_VALUE =
{
    ...
    // AF NVRAM
    {
        ...
        // -------------------- sAF_TH ---------------------
        {
            ...
            {3, 3, 4, 4, 5, 5, 6, 7/*3, 3, 3, 4, 4, 5, 5, 8*/},
            ...
            {3, 3, 4, 4, 5, 5, 6, 7/*6, 6, 6, 6, 7, 8, 8, 12*/},
        },
        // ------------------- sZSDAF_TH -----------------------------------
        {
            8, // i4ISONum;
           {100, 150, 200, 300, 400, 600, 800, 1600},
            ...
            // SGG1~7
            {19, 19, 19, 18, 18, 17, 16, 14,
             29, 28, 28, 27, 27, 26, 25, 23,
             42, 42, 41, 41, 40, 39, 39, 36,
             61, 61, 60, 60, 59, 59, 58, 55,
             88, 88, 87, 87, 86, 86, 85, 83,
           ...
           // horizontal FV threshold
            {3, 3, 4, 5, 5, 6, 7, 7/*5, 5, 6, 7, 8, 9, 11, 16*/},
           ...
           // vertical FV threshold
            {3, 3, 4, 5, 5, 6, 7, 7/*8, 8, 10, 12, 14, 16, 18, 27*/},
        },
        // -------------------- sVID_AF_TH ---------------------
        {
            0, // i4ISONum;
        ...
        { 
         ...
         0, // [1] fdOffMaxCnt: 0 is using default value 10
            ...
            0, 10, 40,  5, 100, 50, 150, 50, 0, 0,     // [11~20] for DAF
            0, 50, 70,  5, 100, 50, 150, 50, 0, 0,     // [21~30] for PDAF
